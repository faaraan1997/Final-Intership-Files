...
model_path = "/scratch/faaraan/SparrowVQA_Model/Sparrowvqe/checkpoints/SparrowVQE-3b-stage3"
...
# Save the records as a JSON array
output_path = '/scratch/faaraan/SparrowVQA_Model/Q_A_with_predictions_and_rouge.json'
